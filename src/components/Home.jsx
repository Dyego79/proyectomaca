...
const Home = () => {
  ...
  return (
    <>
      <section
        id="inicio"
        className="bg-slate-400 w-full sm:h-[78vh]  h-[55vh] hero flex items-center relative px-12"
      >
        <div className="container mx-auto flex flex-col items-start sm:px-5">
          ...
          <h2 className="encabezadoMascotas text-white drop-shadow-[5px_5px_5px_rgba(0,0,0,0.8)]">
            Happy Pets <br />
            in happy houses!
          </h2>
          <a
      ...
      <main id="servicios" className="bg-slate-300 px-5 relative pt-12">
        ...
        <div className="flex flex-col gap-y-20 md:flex-row sm:py-16 h-full">
          <div className="flex flex-col items-center gap-y-8 md:w-1/2">
            ...
            <h3 className="h3-servicios">
              Become a <span>host</span> for pets!
            </h3>
          ...
          <div className="flex flex-col items-center gap-y-8 md:w-1/2">
            ...
            <h3 className="h3-servicios">
              Find a <span>temporary home</span> for your pet
            </h3>
            <button className=" bg-magentaMaca rounded-full px-8 pt-2 btn-servicios">
              ¡Very Soon!
            </button>
      ...
      <div className="slides md:px-6 pt-16 xl:px-40 sm:bg-white">
        <div className="text-center historias">
          <h2 className="text-3xl">Happy users stories</h2>
        </div>
        <div className="pt-12">
          <Slides />
        </div>
      ...
      <section className="bg-slate-300 py-16">
        <section className="promo flex flex-col md:flex-row md:gap-x-16 gap-y-12 container mx-auto text-center px-6 md:px-12">
          <div className="flex flex-col items-center gap-y-3 md:1/3">
            <img src="/img/Icongift.png" className="h-32" />
            <h2 className="boldFont text-3xl mt-5">Promotions and discounts</h2>
            <p className="regularFont text-2xl text-slate-600">
                10% discount reserving accommodation for more than a week
                continuous or, more than 30 days in a period of 3 months.
            </p>
          </div>
          <div className="flex flex-col items-center gap-y-3 md:1/3">
